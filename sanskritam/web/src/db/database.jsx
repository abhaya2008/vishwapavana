...
async function sGetDhatuForms(baseindex) {
    if (!(baseindex in _dhatuFormsCache)) {
        try {
            _dhatuFormsCache[baseindex] = await staticGet(`dhatuforms/${baseindex}.json`);
        } catch (_) {
            _dhatuFormsCache[baseindex] = null;
        }
    }
